...
class Masmorra:
    ...
    def gerar_boss(self) -> Inimigo:
        ...
        return Inimigo(nome, hp=hp, atk=atk, dificuldade=3, xp=xp,moedas=moedas,hp_bonus = 3, atk_bonus= 1)
    ...
    def gerar_mimico(self) -> Inimigo:
        ...
        return Inimigo(nome, hp=hp, atk=atk, dificuldade=2, xp=xp,moedas=moedas, hp_bonus=0, atk_bonus=0)
    ...
    def _combate_interativo(self, inimigo: Inimigo) -> str:
        ...
        self.jogador.ganhar_xp(inimigo.xp)
        self.jogador.ganhar_moedas(inimigo.moedas)
        self.jogador.aumenta_hp_max(inimigo.hp_bonus)
        self.jogador.curar(inimigo.hp_bonus)
        self.jogador.aumenta_atk(inimigo.atk_bonus)
        return "vitoria"
